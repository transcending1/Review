...
The maximum absolute value normalization adjusts each feature to the range of - 1,1, which is divided by the maximum absolute value within each feature. It does not move and aggregate data, so it does not break any sparsity.
